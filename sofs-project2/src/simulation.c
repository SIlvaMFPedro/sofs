...
int main(int argc, char* argv[])
{
   ...
   Parameters params = {20,10,100,3,2,5,5,20,50,10,15};
...
static void go(Simulation* sim)
{
   ...
   //printf("Waiter launched\n");
   
   int i;
   for(i=0; i<sim->params->NUM_PHILOSOPHERS;i++){
      pthread_create((pthread_t*)&sim->philosophers_thread[i],NULL,launch_phil, (int*)i);
      //printf("Philosopher %d launched\n",i+1);
   }
...
Simulation* initSimulation(Simulation* sim, Parameters* params)
{
   ...
   //result->threads = (Threads*)mem_alloc(sizeof(Threads));
   //Threads t = {NULL, PTHREAD_ONCE_INIT, PTHREAD_COND_INITIALIZER, PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER,PTHREAD_MUTEX_INITIALIZER};
   //memcpy(result->threads, &t, sizeof(Threads));
